translate = {
  ...
  "LEVELONE_FOREX" : [
    ...
    "Last Price",    "Bid Size",    "Ask Size",
    "Total Volume",  "Last Size",   "Quote Time",
    "Trade Time",    "High Price",  "Low Price",
    "Close Price",   "Exchange",    "Description",
    "Open Price",    "Net Change",  "Percent Change",
    "Exchange Name", "Digits",      "Security Status",
    "Tick",          "Tick Amount", "Product",
    "Trading Hours", "Is Tradable", "Market Maker",
    "52 Week High",  "52 Week Low", "Mark"
  ],
  "NYSE_BOOK" : {
    0 : "Symbol",
    ...
    3 : "Ask Side Levels",
    "Price Levels" : [
      "Price", "Aggregate Size",
      "Market Maker Count"
      "Array of Market Makers"
    ],
  ...
  "CHART_FUTURES" : [
    "key", "Chart Time", "Open Price", "High Price", "Low Price", "Close Price",
    "Volume"
  ],
  "SCREENER_EQUITY" :
